...
import { loadTranslations, getAvailableLanguages, fixSourceInconsistencies, evaluateFilePath, } from './util/file-system';
...
commander
    ...
    .parse(process.argv);
export var translate = function (inputDir, cacheDir, sourceLang, targetLangs, deleteUnusedStrings, fileType, dirStructure, fixInconsistencies, service, matcher, decodeEscapes, config) {
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    ...
                    availableLanguages = getAvailableLanguages(workingDir, dirStructure);
                    targetLanguages = targetLangs || availableLanguages.filter(function (f) { return f !== sourceLang; });
                    ...
                    translationService = serviceMap[service];
                    templateFilePath = evaluateFilePath(workingDir, dirStructure, sourceLang);
                    templateFiles = loadTranslations(templateFilePath, fileType);
                    if (templateFiles.length === 0) {
                        throw new Error("The source language " + sourceLang + " doesn't contain any JSON files.");
                    }
                    console.log(chalk(templateObject_1 || (templateObject_1 = __makeTemplateObject(["Found {green.bold ", "} target language(s):"], ["Found {green.bold ",
                    ...
                    for (_i = 0, templateFiles_1 = templateFiles; _i < templateFiles_1.length; _i++) {
                        ...
                        console.log(chalk(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\u251C\u2500\u2500 ", " (", ")"], ["\u251C\u2500\u2500 ", " (", ")"])), String(file.name), file.type));
                    }
                    console.log(chalk(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\u2514\u2500\u2500 {green.bold Done}"], ["\u2514\u2500\u2500 {green.bold Done}"]))));
                    console.log();
                    console.log("\u2728 Initializing " + translationService.name + "...");
                    return [4 /*yield*/, translationService.initialize(config, matcherMap[matcher], decodeEscapes)];
                case 1:
                    _f.sent();
                    console.log(chalk(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\u2514\u2500\u2500 {green.bold Done}"], ["\u2514\u2500\u2500 {green.bold Done}"]))));
                    console.log();
                    ...
                    _loop_1 = function (file) {
                        ...
                        if (inconsistentKeys.length > 0) {
                            ...
                            console.log(chalk(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\u251C\u2500\u2500 {yellow.bold ", " contains} {red.bold ", "} {yellow.bold inconsistent key(s)}"], ["\u251C\u2500\u2500 {yellow.bold ", " contains} {red.bold ",
                    ...
                    if (inconsistentFiles.length > 0) {
                        console.log(chalk(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\u2514\u2500\u2500 {yellow.bold Found key-value inconsistencies in} {red.bold ", "} {yellow.bold file(s).}"], ["\u2514\u2500\u2500 {yellow.bold Found key-value inconsistencies in} {red.bold ",
                            "} {yellow.bold file(s).}"])), String(inconsistentFiles.length)));
                        console.log();
                        if (fixInconsistencies) {
                            console.log("\uD83D\uDC9A Fixing inconsistencies...");
                            fixSourceInconsistencies(templateFilePath, evaluateFilePath(resolvedCacheDir, dirStructure, sourceLang));
                            console.log(chalk(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\u2514\u2500\u2500 {green.bold Fixed all inconsistencies.}"], ["\u2514\u2500\u2500 {green.bold Fixed all inconsistencies.}"]))));
                        }
                        else {
                            console.log(chalk(templateObject_8 || (templateObject_8 = __makeTemplateObject(["Please either fix these inconsistencies manually or supply the {green.bold -f} flag to automatically fix them."], ["Please either fix these inconsistencies manually or supply the {green.bold -f} flag to automatically fix them."]))));
                        }
                    }
                    else {
                        console.log(chalk(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\u2514\u2500\u2500 {green.bold No inconsistencies found}"], ["\u2514\u2500\u2500 {green.bold No inconsistencies found}"]))));
                    }
                    console.log();
                    ...
                    _loop_2 = function (file) {
                        ...
                        if (invalidKeys.length > 0) {
                            ...
                            console.log(chalk(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\u251C\u2500\u2500 {yellow.bold ", " contains} {red.bold ", "} {yellow.bold invalid key(s)}"], ["\u251C\u2500\u2500 {yellow.bold ", " contains} {red.bold ",
                    ...
                    if (invalidFiles.length) {
                        console.log(chalk(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\u2514\u2500\u2500 {yellow.bold Found invalid keys in} {red.bold ", "} {yellow.bold file(s).}"], ["\u2514\u2500\u2500 {yellow.bold Found invalid keys in} {red.bold ",
                            "} {yellow.bold file(s).}"])), String(invalidFiles.length)));
                        console.log();
                        console.log(chalk(templateObject_12 || (templateObject_12 = __makeTemplateObject(["It looks like you're trying to use the key-based mode on natural-language-style JSON files."], ["It looks like you're trying to use the key-based mode on natural-language-style JSON files."]))));
                        console.log(chalk(templateObject_13 || (templateObject_13 = __makeTemplateObject(["Please make sure that your keys don't contain periods (.) or remove the {green.bold --type} / {green.bold -t} option."], ["Please make sure that your keys don't contain periods (.) or remove the {green.bold --type} / {green.bold -t} option."]))));
                        console.log();
                        process.exit(1);
                    }
                    else {
                        console.log(chalk(templateObject_14 || (templateObject_14 = __makeTemplateObject(["\u2514\u2500\u2500 {green.bold No invalid keys found}"], ["\u2514\u2500\u2500 {green.bold No invalid keys found}"]))));
                    }
                    console.log();
                            ...
                            switch (_d.label) {
                                case 0:
                                    if (!translationService.supportsLanguage(language)) {
                                        console.log(chalk(templateObject_15 || (templateObject_15 = __makeTemplateObject(["\uD83D\uDE48 {yellow.bold ", " doesn't support} {red.bold ", "}{yellow.bold . Skipping this language.}"], ["\uD83D\uDE48 {yellow.bold ", " doesn't support} {red.bold ", "}{yellow.bold . Skipping this language.}"])), translationService.name, language));
                                        console.log();
                                        return [2 /*return*/, "continue"];
                                    }
                                    console.log(chalk(templateObject_16 || (templateObject_16 = __makeTemplateObject(["\uD83D\uDCAC Translating strings from {green.bold ", "} to {green.bold ", "}..."], ["\uD83D\uDCAC Translating strings from {green.bold ", "} to {green.bold ", "}..."])), sourceLang, language));
                                    ...
                                    return [3 /*break*/, 8];
                                case 1:
                                    existingFiles = loadTranslations(evaluateFilePath(workingDir, dirStructure, language), fileType);
                                    if (deleteUnusedStrings) {
                                        ...
                                        for (_i = 0, deletableFiles_1 = deletableFiles; _i < deletableFiles_1.length; _i++) {
                                            ...
                                            console.log(chalk(templateObject_17 || (templateObject_17 = __makeTemplateObject(["\u251C\u2500\u2500 {red.bold ", " is no longer used and will be deleted.}"], ["\u251C\u2500\u2500 {red.bold ", " is no longer used and will be deleted.}"])), file.name));
                                            fs.unlinkSync(path.resolve(evaluateFilePath(workingDir, dirStructure, language), file.name));
                                            cacheFile = path.resolve(evaluateFilePath(workingDir, dirStructure, language), file.name);
                                ...
                                case 7:
                                    ...
                                    return [3 /*break*/, 8];
                                case 8:
                                    console.log(chalk(templateObject_18 || (templateObject_18 = __makeTemplateObject(["\u2514\u2500\u2500 {green.bold All strings have been translated.}"], ["\u2514\u2500\u2500 {green.bold All strings have been translated.}"]))));
                                    console.log();
                                    return [2 /*return*/];
                            }
                        });
                ...
                case 5:
                    ...
                    return [4 /*yield*/, new Promise(function (res, rej) {
                            return ncp(evaluateFilePath(workingDir, dirStructure, sourceLang), evaluateFilePath(resolvedCacheDir, dirStructure, sourceLang), function (err) { return (err ? rej() : res(null)); });
                        })];
                case 6:
                    _f.sent();
                    console.log(chalk(templateObject_19 || (templateObject_19 = __makeTemplateObject(["\u2514\u2500\u2500 {green.bold Translation files have been cached.}"], ["\u2514\u2500\u2500 {green.bold Translation files have been cached.}"]))));
                    console.log();
                    _f.label = 7;
                case 7:
                    console.log(chalk.green.bold(totalAddedTranslations + " new translations have been added!"));
                    if (totalRemovedTranslations > 0) {
                        console.log(chalk.green.bold(totalRemovedTranslations + " translations have been removed!"));
                    }
                    return [2 /*return*/];
            }
        });
...
translate(commander.input, commander.cacheDir, commander.sourceLanguage, commander.deleteUnusedStrings, commander.type, commander.directoryStructure, commander.fixInconsistencies, commander.service, commander.matcher, commander.decodeEscapes, commander.config)["catch"](function (e) {
    console.log();
...
function createTranslator(translationService, service, sourceLang, targetLang, cacheDir, workingDir, dirStructure, deleteUnusedStrings) {
    ...
    return function (sourceFile, destinationFile) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    cachePath = path.resolve(evaluateFilePath(cacheDir, dirStructure, sourceLang), sourceFile ? sourceFile.name : '');
                    cacheDiff = [];
                    if (fs.existsSync(cachePath) && !fs.statSync(cachePath).isDirectory()) {
                        ...
                        cDiff_1 = diff(cachedFile, sourceFile.content);
                        cacheDiff = Object.keys(cDiff_1).filter(function (k) { return cDiff_1[k]; });
                        changedItems = Object.keys(cacheDiff).length.toString();
                        process.stdout.write(chalk(templateObject_20 || (templateObject_20 = __makeTemplateObject([" ({green.bold ", "} changes from cache)"], [" ({green.bold ", "} changes from cache)"])), changedItems));
                    }
                ...
                case 1:
                    ...
                    if (service !== 'dry-run') {
                        existingTranslations = destinationFile
                            ...
                            : {};
                        translatedFile = __assign(__assign({}, omit(existingTranslations, deleteUnusedStrings ? unusedStrings : [])), newKeys);
                        newContent = JSON.stringify(sourceFile.type === 'key-based'
                            ? flatten.undo(translatedFile)
                            : translatedFile, null, 2) + "\n";
                        fs.writeFileSync(path.resolve(evaluateFilePath(workingDir, dirStructure, targetLang), (_a = destinationFile === null || destinationFile === void 0 ? void 0 : destinationFile.name) !== null && _a !== void 0 ? _a : sourceFile.name), newContent);
                        languageCachePath = evaluateFilePath(cacheDir, dirStructure, targetLang);
                    ...
                    console.log(deleteUnusedStrings && unusedStrings.length > 0
                        ? chalk(templateObject_21 || (templateObject_21 = __makeTemplateObject([" ({green.bold +", "}/{red.bold -", "})"], [" ({green.bold +",
                            "}/{red.bold -", "})"])), String(translatedStrings.length), String(unusedStrings.length)) : chalk(templateObject_22 || (templateObject_22 = __makeTemplateObject([" ({green.bold +", "})"], [" ({green.bold +", "})"])), String(translatedStrings.length)));
