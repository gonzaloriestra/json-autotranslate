...
commander_1["default"]
    ...
    .option('-o, --target-languages <sourceLang>', 'specify the target languages', 'es')
    ...
    .parse(process.argv);
var translate = function (inputDir, cacheDir, sourceLang, targetLangs, deleteUnusedStrings, fileType, dirStructure, fixInconsistencies, service, matcher, decodeEscapes, config) {
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    ...
                    targetLanguages = targetLangs.split(',') || availableLanguages.filter(function (f) { return f !== sourceLang; });
