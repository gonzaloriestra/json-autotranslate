...
export const getAvailableLanguages = (directory, directoryStructure) => {
...
export const detectFileType = (json) => {
...
export const loadTranslations = (directory, fileType = 'auto') => fs
...
export const fixSourceInconsistencies = (directory, cacheDir) => {
...
export const evaluateFilePath = (directory, dirStructure, lang) => {
    switch (dirStructure) {
        case 'default':
