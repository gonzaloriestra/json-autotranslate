...
var DeepL = /** @class */ (function () {
    ...
    DeepL.prototype.initialize = function (config, interpolationMatcher, decodeEscapes) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, apiKey, formality, languages;
    ...
    DeepL.prototype.getFormalityLanguages = function (languages) {
        var supportedLangauges = languages.filter(function (l) { return l.supports_formality; });
    ...
    DeepL.prototype.translateString = function (string, from, to, triesLeft) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        _a = replaceInterpolations(string.value, this.interpolationMatcher), clean = _a.clean, replacements = _a.replacements;
                        ...
                        return [4 /*yield*/, fetch(String(url))];
                    case 1:
                        response = _e.sent();
